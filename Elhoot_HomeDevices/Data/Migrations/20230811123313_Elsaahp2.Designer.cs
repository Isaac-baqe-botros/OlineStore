...
namespace Elhoot_HomeDevices.Data.Migrations
{
    ...
    [Migration("20230811123313_Elsaahp2")]
    partial class Elsaahp2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.Elsaahp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("TotalPriceCount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.SelectedDateElsaahp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SelecteddataDyantId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ElsaahpId");

                    b.HasIndex("MadunaateId");

                    b.HasIndex("SelecteddataDyantId");

                    b.ToTable("SelectedDateElsaahp");
                });

            modelBuilder.Entity("Elhoot_HomeDevices.Data.SelecteddataDyant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DayeenateyId")
                        .HasColumnType("int");

                    b.Property<int>("DeenID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DayeenateyId");

                    b.ToTable("selecteddataDyants");
                });
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.OrderItem", b =>
                {
                    ...
                    b.HasOne("Elhoot_HomeDevices.Data.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.Product", b =>
                {
                    b.HasOne("Elhoot_HomeDevices.Data.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.SelectedDateElsaahp", b =>
                {
                    b.HasOne("Elhoot_HomeDevices.Data.Elsaahp", "Elsaahp")
                        .WithMany()
                        .HasForeignKey("ElsaahpId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("Elhoot_HomeDevices.Data.SelecteddataDyant", null)
                        .WithMany("selectedDatesRange")
                        .HasForeignKey("SelecteddataDyantId");

                    b.Navigation("Elsaahp");
            ...
            modelBuilder.Entity("Elhoot_HomeDevices.Data.SelecteddataDyant", b =>
                {
                    b.HasOne("Elhoot_HomeDevices.Data.Dayeenatey", "Dayeenatey")
                        .WithMany("selectedDatesRange")
                        .HasForeignKey("DayeenateyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Dayeenatey");
                });
